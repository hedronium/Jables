...
`php jables:create-table` - Creates Jables own tracking table in database.  

All the commands accept the  `php artisan jables --database=[connection]` option. You can use it to override which connection Jables uses to do its business.
